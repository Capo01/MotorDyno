...
print("Looking for my_odrive")
my_odrive = odrive.find_any(timeout=15.0, find_multiple=True)
print("Found my_odrive")
my_odrive0 = my_odrive[0]
print(my_odrive0.serial_number)
my_odrive1 = my_odrive[1]
print(my_odrive1.serial_number)
